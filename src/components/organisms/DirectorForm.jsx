...
export const DirectorForm = ({ director }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (director?.id) {
                await axios.post(
                    `https://web-final-backend.herokuapp.com/api/v1/director/${director.id}/update`,
                    //`https://127.0.0.1:8000/api/v1/director/${director.id}/update`,
                    { ...form }, { headers: { 'accept': 'application/json', 'authorization': token } }
                );
            } else {
                await axios.post(
                    `https://web-final-backend.herokuapp.com/api/v1/director/create`,
                    //`https://127.0.0.1:8000/api/v1/director/create`,
                    { ...form }, { headers: { 'accept': 'application/json', 'authorization': token } }
                );
            }
            navigate('/directors');
