...
class JailController extends Controller
{
    ...
    *  * @OA\Get(
     ** path="/jail/",
     *   tags={"Administrar carceles (ROL DIRECTOR)"},
     *   summary="Listar celdas de la prision",
     *   operationId="jail",
     *security={
     *  {"passport": {}},
     *   },
    ...
    *  * @OA\Post(
     ** path="/jail/create",
     *   tags={"Administrar carceles (ROL DIRECTOR)"},
     *   summary="Crear nuevas celdas de la prision",
     ...
     *            @OA\Schema(
     *               type="object",
     *               required={"name","code","type","capacity","ward_id","description",},
     *               @OA\Property(property="name", type="string"),
     *               @OA\Property(property="code", type="string"),
     *               @OA\Property(property="type", type="string"),
     *               @OA\Property(property="capacity", type="string"),
     *               @OA\Property(property="ward_id", type="string"),
    ...
    public function show(Jail $jail)
    {
        ...
        return $this->sendResponse(message: 'Jail details', result: [
            'jail' => new JailResource($jail)
               ...
               /**
    *  * @OA\Post(
     ** path="/jail/{jail}/update",
     *   tags={"Administrar carceles (ROL DIRECTOR)"},
     *   summary="Actualizar celdas de la prision",
     *   operationId="jail-update",
     *security={
     *  {"passport": {}},
     *   },
     *   @OA\Parameter(
