...
class PrisonerToJailController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('verify.jail.assignment')->only('assign');
               ...
               /**
    *  * @OA\Get(
     ** path="/assignment/prisoners-and-jails",
     *   tags={"Asignacion prisioneros - carceles (ROL - DIRECTOR)"},
     *   summary="Listar los prisioneros asignados a carceles",
     *   operationId="assignment-(prisioners-jail)",
     *security={
     *  {"passport": {}},
     *   },
     *
    ...
    public function index()
    {
        ...
        return $this->sendResponse(message: 'Assignment between prisoners and jails generated successfully', result: [
            ...
            'jails' => SpaceResource::collection($jails)
                  ...
                  /**
    *  * @OA\Get(
     ** path="/assignment/prisoner-to-jail/{user}/{jail}",
     *   tags={"Asignacion prisioneros - carceles (ROL - DIRECTOR)"},
     *   summary="Asignar prisioneros a carceles",
     *   operationId="assignment-prisoner-jail ",
     *security={
     *  {"passport": {}},
     *   },
     *   @OA\Parameter(
